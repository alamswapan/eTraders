<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AidAllocationBySector.aspx.cs"
    MasterPageFile="~/Views/Shared/Site.Master" Inherits="AIMS_UNDP.Web.Areas.AIMS.ReportViews.AidAllocationBySector" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="widget-box">
        <div class="widget-header">
            <h4>
                Aid Allocation By Sector</h4>
        </div>
        <div class="widget-body">
            <div class="widget-main">
                <div class="row-fluid">
                    <div class="span6">
                        <span class="control-label span4">Calendar Type</span>
                        <div class="span8">
                            <asp:RadioButtonList ID="rbSelectYear" runat="server" RepeatDirection="Horizontal" Width="100%"
                                ...
                                <asp:ListItem Text="Calender Year" Value="1" Selected="True"/>
                                <asp:ListItem Text="Financial Year" Value="2"/>
                            </asp:RadioButtonList>
                        </div>
                    </div>
                    <div class="span6">
                        <span class="control-label span4">Budget Type</span>
                        <div class="span8">
                            <asp:RadioButtonList ID="rbSelectBudget" runat="server" RepeatDirection="Horizontal" Width="100%">
                                <asp:ListItem Text="On-Budget" Value="1" Selected="True"/>
                                <asp:ListItem Text="Off-Budget" Value="0"/>
                ...
                <div class="row-fluid">
                    <div class="span6 divCalYear">
                        <span class="control-label span4">Calendar Year </span>
                        <div class="controls span8">
                            <asp:DropDownList ID="ddlYear" runat="server"/>
                        </div>
                    </div>
                    <div class="span6 divFisYear" style="float: left; margin-left: -0px;">
                        <span class="control-label span4">Financial Year </span>
                        <div class="controls span8">
