<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SectoralTrendsNAidAllocation.aspx.cs"
    MasterPageFile="~/Views/Shared/Site.Master" Inherits="AIMS_UNDP.Web.Areas.AIMS.ReportViews.SectoralTrendsNAidAllocation" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="Server">
   Sectoral Trends and Aid Allocation
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <form id="Form1" runat="server" >
    <div class="widget-box">
        <div class="widget-header">
            <h4> Sectoral Trends and Aid Allocation</h4>
        </div>
            ...
            <div class="row-fluid">
                <div class="span6 divCalYear">
                    ...
                    <div class="controls span8">
                        <asp:DropDownList ID="ddlStartCalenderYear" runat="server"></asp:DropDownList>
                    </div>
                </div>
                <div class="span6 divCalYear">
                    <span class="control-label span4">
                    ...
                    <div class="controls span8">
                        <asp:DropDownList ID="ddlEndCalenderYear" runat="server"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row-fluid">
                <div class="span6 divFisYear">
                    ...
                    <div class="controls span8">
                        <asp:DropDownList ID="ddlStartFinancialYear" runat="server"></asp:DropDownList>
                    </div>
                </div>
                <div class="span6 divFisYear">
                    <span class="control-label span4">
                    ...
                    <div class="controls span8">
                        <asp:DropDownList ID="ddlEndFinancialYear" runat="server"></asp:DropDownList>
                    </div>
                </div>
            </div>
