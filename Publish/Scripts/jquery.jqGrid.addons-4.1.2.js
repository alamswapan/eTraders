                ...
                var formFill = function () {
                    ...
                    $.each(self.p.filterModel, function (i, n) {
                        ...
                        if (self.p.formtype == 'horizontal') {
                            ...
                            if (m > 2) {
                                mv = m % 2;
                                if (mv > 0) tr1 = document.createElement("tr");
                    ...
                    if (self.p.enableSearch === true) {
                        ...
                        sb = "<div class='buttonSubmit'><span></span><input type='button' id='sButton' style='width: auto; overflow: visible; padding-left: .25em; padding-right: .25em;' class='" + self.p.buttonclass + "' value='" + self.p.searchButton + "'/></div>";
                        $(td).append(sb);
                    ...
                    if (self.p.enableClear === true) {
                        ...
                        cb = "<div class='buttonSubmit'>&nbsp;</div><div class='buttonSubmit'><span></span><input type='button' id='cButton' style='width: auto; overflow: visible; padding-left: .25em; padding-right: .25em;' class='" + self.p.buttonclass + "' value='" + self.p.clearButton + "'/></div>";
                        $(td).append(cb);
