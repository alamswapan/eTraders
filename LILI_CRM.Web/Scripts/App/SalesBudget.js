...
$(document).ready(function () {
    ...
    $("#SalesBudgetKendoGrid").kendoGrid({
        dataSource: {
            transport: {
                read: "/PCV/SalesBudget/SalesBudgetRead"
            },
            schema: {
                model: {
                    fields: {
        ...
        columns: [{ field: "Id", title: "Id", hidden: false, filterable: false, sortable: false, width: "10%" },
                ...
                { field: "ProductName", title: "Product", width: "25%" },
    ...
    //add SampleRequest
    $('#lnkAddSalesBudget').live('click', function () {

        //change the title of the dialog
        var linkObj = $(this);
        var dialogDiv = $('#addSalesBudgetDialog');
    ...
    $('#SalesBudgetKendoGrid tbody tr td a.lnkEditSalesBudget').live('click', function () {

        //change the title of the dialog
        var linkObj = $(this);
        var dialogDiv = $('#editSalesBudgetDialog');
        var viewUrl = linkObj.attr('href');
        $.get(viewUrl, function (data) {
            dialogDiv.html(data);

            //get form
            var $form = $("#editSalesBudgetForm");
